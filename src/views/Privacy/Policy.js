...
/**
 * Policy content for the privacy policy component.
 *
 * @returns {React.Component} The policy component
 */
export default function Policy() {
  return (
    <>
      <h2 className="text-center">Privacy Policy</h2>
      <p className="text-center pb-12">Last updated: June 28, 2021</p>
      <p>
      ...
      <ul className="ml-10">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Calculate Tax NZ.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Calculate Tax NZ, accessible from{" "}
            <a
              href="https://calculatetax.nz/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://calculatetax.nz/
            </a>
          </p>
        </li>
        <li>
      ...
      <h2>Contact Us</h2>
      <p>
        If you have any questions about this Privacy Policy, You can contact via
        by email:{" "}
        <a href="mailto:contact@joshuabooth.nz">contact@joshuabooth.nz</a>
      </p>
    </>
  );
}
